  ...
  return (
    <div className={`w-full font-sans ${containerClasses}`}>
      ...
      <div className="relative">
        ...
        {!!icon ? (
          <div
            className={`absolute left-0 top-0 flex items-center justify-center text-muted-400 transition-colors duration-300 peer-focus-visible:text-[#17161a] dark:text-muted-500 
            ${size === "sm" ? "h-8 w-8" : ""} 
            ${size === "md" ? "h-10 w-10" : ""} 
            ${size === "lg" ? "h-12 w-12" : ""}`}
          >
