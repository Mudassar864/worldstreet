      ...
      <div className="max-w-7xl relative pt-6 lg:pt-0 px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="relative rounded-xl p-5 sm:py-16 bg-muted-100 dark:bg-neutral-950">
          ...
          <div className="relative z-10 text-center mx-auto max-w-xl">
            <div className="mb-5">
              <motion.h2
                className="text-3xl md:text-8xl lg:text-6xl font-bold bg-linear-to-r from-yellow-500 to-yellow-500 bg-clip-text text-transparent"
                ...
                ref={headingRef}
              >
                {t("Start Your Trading Journey Now!")}
              </motion.h2>
              <motion.div
              ...
              >
                ...
                >
                  <div className="absolute inset-0 bg-linear-to-r from-yellow-500 to-yellow-500 rounded-lg" />
