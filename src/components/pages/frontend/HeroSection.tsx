      ...
      <div className="max-w-7xl relative pt-12 lg:pt-0 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="text-center md:text-left flex flex-col justify-center">
            ...
            >
              {t("Trading Made     Easy on the")}{" "}
              <span className="bg-linear-to-r from-yellow-500 to-yellow-500 bg-clip-text text-transparent">
                {t("Worldstreet")}
              </span>{" "}
              {t("                  community")} 
            </motion.h1>
            ...
            >
              {t(
                "Get expert-level support, information on the best cryptocurrencies & commodities to invest in."
              )}
            </motion.p>
            {isLoggedIn && pnl ? (
              <motion.div
